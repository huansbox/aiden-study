...
2026-09-14 家長已回報：設定家庭金鑰後自動載入六題、重開接續並保留已送出進度、未送出輸入清空、哥哥／弟弟進度隔離。環境已知為 **iPad、橫向**；由 iPhone 透過 AirDrop 傳網址至 iPad 後直接開啟，尚未建立主畫面圖示；瀏覽器名稱、型號與 iPadOS 版本未知。這是家長操作證據，未讀取真 token、題文或孩子雲端進度，也未擷取真機 HTTP trace。
...
1. 先依驗收紀錄補記瀏覽器名稱與已測離開路徑；四項已回報結果保留，不重新當作未開始。

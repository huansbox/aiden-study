...
**目前造型仍在修正中。** 使用者檢視實際預覽後指出，現版太像實車模型，沒有達到先前確認的積木感。下方 E2E 紀錄證明功能流程可用，不代表現版造型已通過確認。最新工作先縮至「車頭＋一組輪組」的 [實際 3D 小樣](../scripts/e500-art/PROTOTYPE-NOTES.md)，待造型對齊後才延伸整台及替換正式素材。

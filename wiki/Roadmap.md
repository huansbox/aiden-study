...
目前優先定下每天使用的入口：首頁往返已發布，#35 首輪真機跨頁失敗，目前先複驗 scope-v2 候選設定，再由 #34 上線正式網域與兩個孩子圖示。2026-09-15 家長確認尚未正式給孩子使用，本次不備份／還原／對帳舊進度；舊 repo 清理與錄音在本輪之後處理，擴題由 #60 另案進行，不改變網域 gate。

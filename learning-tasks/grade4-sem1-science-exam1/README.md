...
這頁記錄**原卷收集階段**；下文「本次 App 新增／上線 0」只指當時未轉題。後續已有[自然首批 20 個 activity 正式上線](../../data/study/g4-s1-science-exam1/README.md)；[第二批 #119](https://github.com/huansbox/aiden-study/issues/119)仍在製作，不能算已發布。

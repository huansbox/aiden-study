...
本堂原音全檔解碼與3段分聲道ASR已完成。一般語音於2026-09-18改用 OpenAI `gpt-4o-mini-tts-2025-12-15`、Cedar、speed 1.0；36個原題文與檔名保留，詳見 [manifest](source/nativecamp-audio-manifest.json)與[語音查核](source/openai-audio-qa.md)。上方語音比較保留當時的歷史實驗；先前桌面與窄版預覽結果不代替這次語音替換驗收。生成與檔案驗證不代表人耳完整試聽／iPad／孩子實測完成。

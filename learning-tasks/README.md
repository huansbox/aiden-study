...
| --- | --- | --- | --- | --- | --- |
| [悠閒午後閱讀心智圖](leisure-afternoon/) | 已完成（已上線；真機待試用） | 2026-09-15 | 9 歲；成人可陪讀 | 五枝放射圖、各段重點保留、iPad 選詞 | 老師回饋、詩景成組、詩與攝影的關係 |
...
兩次閱讀任務的共通做法已收錄於 [兒童閱讀心智圖](shared/reading-mind-maps.md)，包含注音字型、iPad 尺寸、存檔、重建與發布界線。

...
| --- | --- | --- | --- | --- | --- |
| [Native Camp 回放複習試作](nativecamp-review-pilot/) | 已完成（單堂試作；待孩子實測） | 2026-09-16 | 兒童英語課程；家長協助 | 5-10 分鐘口說；數量、主題預測、too many；孩子／家長分卷 | [分聲道核對與逐字稿誤標](nativecamp-review-pilot/source/evidence-review.md)；私人音檔只存本機 |

...
| --- | --- | --- | --- | --- | --- |
| [Native Camp 回放複習試作](nativecamp-review-pilot/) | 進行中（下載驗證完成；後續方案待採用） | 2026-09-16 | 兒童英語課程；家長協助 | 單堂回放、逐字稿與教材對照；25 分鐘音檔已取得 | [下載驗證與後續方案](nativecamp-review-pilot/source/plan.md)；私人素材只存本機 |

...
| [四上第一次段考自然候選卷](grade4-sem1-science-exam1/) | 進行中；首批四卷已收，32 題已上線；本輪依 #129 補查較早年度與跨版原卷，並補齊既有卷的題型缺口。原卷只存本機。 | — | 9 歲；四年級 | 桃子腳第一次段考前，依地表與水生環境概念篩選歷屆自然卷。 | 來源身分、跨年度概念對照與私人原件驗證 |

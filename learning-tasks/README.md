...
| --- | --- | --- | --- | --- | --- |
| [Native Camp 回放複習試作](nativecamp-review-pilot/) | 紙本已完成；互動版已上線，待孩子實測 | 2026-09-16～17 | 兒童英語課程；家長協助 | 紙本口說；另供 app 的自主題、口說與跨日複習 | [分聲道核對與逐字稿誤標](nativecamp-review-pilot/source/evidence-review.md)；[互動版與音訊](../docs-dev/nativecamp-review.md)；私人音檔不進 Git |

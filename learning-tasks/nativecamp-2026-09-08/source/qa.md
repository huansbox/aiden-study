# 2026-09-08 Maria：驗收紀錄

交付追蹤：[#99](https://github.com/huansbox/aiden-study/issues/99)。以下記錄本次已取得的證據；本堂實作、隔離孩子作答與家長摘要驗收已完成；正式發布與線上核對見 #99 及其關聯 PR。

| 項目 | 已確認結果 |
| --- | --- |
| 來源 | 統籌已讀網站課堂文字，按可確認的教材範圍設計原創短卡片。來源時間與限制見 evidence-review.md；原錄音未下載，未做獨立人耳核對。 詳細時間與出題界線見 [evidence-review.md](evidence-review.md)。 |
...
| 獨立 review | 獨立內容與同日課程支援的 code review 已完成。 Animal homes 的 reserve 題已將有合理語意的 on 混淆改為 from，避免合法答案被判錯。 |
| OpenAI 語音 | 本堂 48 個有效 MP3，Cedar、speed 1.0；[manifest](nativecamp-audio-manifest.json)記錄本次 50 次 API 請求。三堂合計 144 個有效檔、150 次請求，其中 6 份漏句音檔已縮短文字並重製。實際費用未由 Speech API 回應提供，不以請求數冒充帳單。 |
...
| 孩子作答流程 | 隔離孩子流程已完成 Try 8 題、Say 8 題；每概念兩題全對即略過第三題，兩模式皆 Done。Story characters 的 Try 1 實際提交 `the kitten and Nina are characters` 替代排列，判定正確。 |

...
def build_lesson():
    ...
    is_are = {"id": "is-are", "title": "Is or are", "try": [
        ...
        question("is-are", "say", 1, "What can you see?", "Start with There.", scene("dogs", 1),
                 "There is a dog.", "What can you see? Start with there.",
                 accepted=["There is one dog."]),
        question("is-are", "say", 2, "How many trees can you see?", "Start with There.", scene("trees", 4),
                 "There are four trees.", "How many trees can you see? Start with there.",
                 accepted=["There are 4 trees."]),
        question("is-are", "say", 3, "What can you see?", "Start with There.", scene("cats", 2),
    ...
    odd_even = {"id": "odd-even", "title": "Odd or even", "try": [
        ...
        question("odd-even", "say", 1, "Is the number of dogs odd or even?", "Say the number, too.",
        ...
        question("odd-even", "say", 2, "Is 7 odd or even?", "Say the number, too.",
                 {"kind": "numbers", "number": 7}, "Seven is an odd number.",
                 "Is seven odd or even? Say the number, too.", accepted=["Seven is odd."]),
        question("odd-even", "say", 3, "Is the number of books odd or even?", "Say the number, too.",
    ...
    too_many = {"id": "too-many", "title": "Too many", "try": [
        ...
        question("too-many", "say", 1, "Tell me about your toys.", "Use too many in a sentence.",
        ...
        question("too-many", "say", 2, "What is the problem with the books?", "Use too many in a sentence.",
        ...
        question("too-many", "say", 3, "Do you think that Tanya has too many hats?",
                 "Use a full sentence about the hats.",

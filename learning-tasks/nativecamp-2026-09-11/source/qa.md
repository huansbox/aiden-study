...
課程頁逐字稿配合教材交叉核對；確定範圍與限制見 [evidence-review.md](evidence-review.md)。本堂 24 題，經另一位製作者唯讀 cross-review 及整批獨立 delivery review，無未解決的內容／相容性／私人資料 finding。9/10 的 The／the 重複字卡已接受交換，避免正確句子被判錯。

## 語音

本堂 48 段 OpenAI Marin、speed 1.0 預製 MP3。所有檔案解碼、非靜音、長度、SHA256、題文 fingerprint 通過；見 [manifest](nativecamp-audio-manifest.json)。
...
- 本堂全部 24 題都在 Preview 切換、顯示示範，確認答案出現及無播放錯誤；三堂總計 60／60。全數預覽後，測試 progress 仍為 rev 0、data null。
- 以 9/12 較長的 Say it 題目抽查 390 px 窄版，月曆、口說 cue、答案與操作按鈕可見，document scrollWidth 等於 clientWidth；viewport override 已清除。
- Try it：四個概念各 2 題獨立答對，共 8 題；第三題均略過。
- Say it：四個概念各 2 題 Got it，共 8 題。

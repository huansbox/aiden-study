...
**work catalog（作品總覽）**：
把已登錄的 App、家庭學習任務與主線外作品放在一起查找的唯讀目錄；作品是否有可用版本，與目前工作是否完成是兩件事。它不決定孩子首頁可見活動，也不是孩子的練習紀錄。
_Avoid_: registry、家庭設定、工作 tracker

**work series（作品系列）**：
在作品總覽合併顯示的相關作品群，例如 Native Camp App 與各堂課素材；各份素材仍保留自己的來源、日期與狀態，不因分組成為同一份學習任務。

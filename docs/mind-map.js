...
const STEPS = [
  {label:'中心', title:'這篇文章，你想用什麼名字記住？', prompt:'選一個能串起全文的名字。', max:1,
  ...
  {label:'故事', title:'妻子過世後，他怎麼辦？', prompt:'選 1～2 個「典地葬妻」的重點。', max:2,
    options:['不借錢排場','典地辦喪事','簡單辦喪事','做人要節儉'],
    hint:'「典地葬妻」就是把土地典當換錢，辦妻子的喪事。家中沒錢辦喪事，兒子和親戚主張借錢辦得風光。司馬光不同意，教導兒子要節儉，最後把地典當換錢，簡單辦完喪事。'},
